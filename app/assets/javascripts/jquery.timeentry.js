...
function TimeEntry() {
	...
	this._defaults = {
		...
		timeSteps: [1, 30, 0], // Steps for each of hours/minutes/seconds when incrementing/decrementing
		...
		spinnerImage: 'spinnerDefault.gif', // The URL of the images to use for the time spinner
